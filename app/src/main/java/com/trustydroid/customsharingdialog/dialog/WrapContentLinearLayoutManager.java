...
import com.trustydroid.customsharingdialog.BuildConfig;


/**
 * Attempts to make recycler view wrap_content<br>
 * Credits: http://stackoverflow.com/questions/27475178/how-do-i-make-wrap-content-work-on-a-recyclerview
 */
public class WrapContentLinearLayoutManager extends LinearLayoutManager {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        //we want it to wrap content or be maximum the height = android:layout_height
        /*if (exactHeight) {
            height = heightSize;
        } else */
        if (!exactHeight) {
